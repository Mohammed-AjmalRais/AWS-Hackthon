            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-4 lg:grid-cols-3">
                ...
                <div className="rounded-xl border border-[#EDE6DD] bg-[#FAF7F2]/80 p-4.5 flex flex-col justify-between shadow-2xs">
                  ...
                  <div className="mt-4 pt-3 border-t border-[#EDE6DD] text-[11px] text-slate-500">
                ...
                <div className="rounded-xl border border-[#DFC8A5] bg-amber-50/40 p-4.5 relative flex flex-col justify-between shadow-2xs">
                  ...
                  <div>
                    ...
                    <h5 className="text-xs font-bold text-amber-950 mb-2 font-serif">
                      ...
                      <ul className="space-y-3">
                        {currentRoadmap.tier2StatutoryCertificates.map((cert, idx) => (
                          <li
                            ...
                            className="rounded-lg border border-[#DFC8A5] bg-white p-3 text-xs text-slate-800 cursor-pointer hover:border-[#DFB738] transition-colors shadow-2xs"
                          >
                            <div className="flex items-start gap-2">
                              ...
                              <div className="flex-1 min-w-0">
                                <span className="font-bold text-[#0B1B4F] block truncate font-serif">{cert.name}</span>
                  ...
                  <div className="mt-4 pt-3 border-t border-[#DFC8A5]/60 text-[11px] text-amber-900 font-medium">
                ...
                <div className="rounded-xl border border-[#DFC8A5] bg-[#FAF7F2]/80 p-4.5 relative flex flex-col justify-between shadow-2xs">
                  ...
                  <div className="mt-4 pt-3 border-t border-[#EDE6DD] text-[11px] text-[#0B1B4F] font-semibold">
